...
estimates_1 <- 
  foreach(n_grid = seq(10, 100, by = 10), .multicombine = TRUE, 
          .packages = c("maxLik", "numDeriv")) %dopar% 
  Table_Cpm(n_grid, p = c(1, 2, 3), alpha = c(0.4, 0.6, 0.8), USL = 7, LSL = 1.3, Tc = 1.86) 
...
estimates_2 <- 
  foreach(n_grid = seq(10, 100, by = 10), .multicombine = TRUE, 
          .packages = c("maxLik", "numDeriv")) %dopar% 
  Table_Cpm(n_grid, p = c(2, 5, 10), alpha = c(0.1, 0.05, 10), USL = 15, LSL = 0.1, Tc = 7.93) 
...
estimates_3 <- 
  foreach(n_grid = seq(10, 100, by = 10), .multicombine = TRUE, 
          .packages = c("maxLik", "numDeriv")) %dopar% 
  Table_Cpm(n_grid, p = c(4, 6, 10), alpha = c(0.3, 0.5, 1.9), USL = 15, LSL = 0.1, Tc = 7.28)
